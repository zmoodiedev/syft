...
export default function RecipeListItem({ recipe, index }: RecipeListItemProps) {
  ...
  return (
    ...
    >
      {recipe.locked ? (
        <div className="relative flex items-center justify-between bg-white border border-stone-100 rounded-2xl px-5 py-3.5 shadow-sm overflow-hidden cursor-default">
          {/* Dimmed content */}
          <div className="min-w-0 flex-1 opacity-40 select-none">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0 ml-4">
            ...
            <span className="text-[10px] font-semibold text-steel/40">Locked</span>
          </div>
        </div>
      ) : (
        <Link
