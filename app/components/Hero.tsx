...
export default function Hero() {
    ...
    return (
        <section id="hero" className="w-full p-10 pt-20  md:min-h-[calc(600px+var(--header-height))] -mt-[var(--header-height)] flex items-stretch isolate relative md:mb-20 z-10 overflow-hidden">
